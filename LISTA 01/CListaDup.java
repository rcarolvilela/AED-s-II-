class CListaDup {
    ...
    private CCelulaDup ultima; // Referencia a ultima  da celula lista 
    private int qtde;
    ...
    public Object retornaIndice(int posicao) {
       // EXERCICIO : deve retornar o elemento da posicao p passada por parametro
       // [cabeca]->[7]->[21]->[13]->null
